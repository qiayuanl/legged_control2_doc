...
exec(open("/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_model/legged_model/default_sphinx_project/conf.py").read())
...
ensure_global('project', "legged_model")
ensure_global('author', """Qiayuan Liao""")
ensure_global('release', "2.1.1")
ensure_global('version', "2.1")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['pinocchio', 'urdfdom']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "legged_model Doxygen Project": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_model/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_model/legged_model/wrapped_sphinx_directory/generated",
