...
exec(open("/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/mujoco_ros2_control_demos/mujoco_ros2_control_demos/default_sphinx_project/conf.py").read())
...
ensure_global('project', "mujoco_ros2_control_demos")
ensure_global('author', """Sangtaek Lee""")
ensure_global('release', "0.1.0")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['position_controllers', 'rclcpp', 'rclcpp_action', 'std_msgs', 'control_msgs', 'joint_trajectory_controller', 'velocity_controllers', 'force_torque_sensor_broadcaster', 'imu_sensor_broadcaster']:
        try:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/mujoco_ros2_control_demos/mujoco_ros2_control_demos/wrapped_sphinx_directory/generated",
