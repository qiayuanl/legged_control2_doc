...
exec(open("/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_estimation/legged_estimation/default_sphinx_project/conf.py").read())
...
ensure_global('project', "legged_estimation")
ensure_global('author', """Qiayuan Liao""")
ensure_global('release', "2.7.3")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['legged_model']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "legged_estimation Doxygen Project": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_estimation/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_estimation/legged_estimation/wrapped_sphinx_directory/generated",
