...
exec(open("/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_control_base/legged_control_base/default_sphinx_project/conf.py").read())
...
ensure_global('project', "legged_control_base")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['legged_model', 'legged_estimation', 'legged_controllers', 'legged_rl_controllers']:
        try:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_control_base/legged_control_base/wrapped_sphinx_directory/generated",
