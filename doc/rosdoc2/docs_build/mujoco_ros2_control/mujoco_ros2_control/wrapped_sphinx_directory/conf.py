...
exec(open("/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/mujoco_ros2_control/mujoco_ros2_control/default_sphinx_project/conf.py").read())
...
ensure_global('project', "mujoco_ros2_control")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['ros2controlcli', 'joint_state_broadcaster', 'effort_controllers', 'rclcpp', 'hardware_interface', 'controller_manager', 'joint_limits', 'pluginlib', 'urdf', 'eigen', 'libglfw3-dev', 'mujoco_sim_ros2', 'mujoco_ament', 'nav_msgs']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "mujoco_ros2_control Doxygen Project": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/mujoco_ros2_control/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/mujoco_ros2_control/mujoco_ros2_control/wrapped_sphinx_directory/generated",
