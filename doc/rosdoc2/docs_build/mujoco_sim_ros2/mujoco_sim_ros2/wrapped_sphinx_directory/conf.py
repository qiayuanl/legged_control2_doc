...
exec(open("/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/mujoco_sim_ros2/mujoco_sim_ros2/default_sphinx_project/conf.py").read())
...
ensure_global('project', "mujoco_sim_ros2")
ensure_global('author', """rdu""")
ensure_global('release', "2.7.0")
ensure_global('version', "2.7")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['mujoco_ament', 'libglfw3-dev', 'git', 'rclcpp', 'pluginlib', 'controller_manager', 'ament_index_cpp']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "mujoco_sim_ros2 Doxygen Project": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/mujoco_sim_ros2/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/mujoco_sim_ros2/mujoco_sim_ros2/wrapped_sphinx_directory/generated",
...
if rosdoc2_settings.get('automatically_extend_intersphinx_mapping', True):
    ...
    ensure_global('intersphinx_mapping', {
        ...
        'legged_controllers': ('http://docs.ros.org/en/latest/p/legged_controllers/', '/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/cross_reference/legged_controllers/objects.inv'),
