...
exec(open("/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_controllers/legged_controllers/default_sphinx_project/conf.py").read())
...
ensure_global('project', "legged_controllers")
ensure_global('author', """Qiayuan Liao""")
ensure_global('release', "3.2.2")
ensure_global('version', "3.2")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['controller_manager', 'ros2controlcli', 'robot_state_publisher', 'joy_linux', 'joy_teleop', 'legged_estimation', 'controller_interface', 'realtime_tools', 'geometry_msgs', 'tf2_msgs', 'nav_msgs', 'visualization_msgs']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "legged_controllers Doxygen Project": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_controllers/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/docs_build/legged_controllers/legged_controllers/wrapped_sphinx_directory/generated",
...
if rosdoc2_settings.get('automatically_extend_intersphinx_mapping', True):
    ...
    ensure_global('intersphinx_mapping', {
        'mujoco_ros2_control': ('http://docs.ros.org/en/latest/p/mujoco_ros2_control/', '/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/cross_reference/mujoco_ros2_control/objects.inv'),
        'mujoco_sim_ros2': ('http://docs.ros.org/en/latest/p/mujoco_sim_ros2/', '/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/cross_reference/mujoco_sim_ros2/objects.inv'),
        'mujoco_ros2_control_demos': ('http://docs.ros.org/en/latest/p/mujoco_ros2_control_demos/', '/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/cross_reference/mujoco_ros2_control_demos/objects.inv'),
        'legged_control_base': ('http://docs.ros.org/en/latest/p/legged_control_base/', '/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/cross_reference/legged_control_base/objects.inv'),
        'legged_model': ('http://docs.ros.org/en/latest/p/legged_model/', '/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/cross_reference/legged_model/objects.inv'),
        'legged_estimation': ('http://docs.ros.org/en/latest/p/legged_estimation/', '/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/cross_reference/legged_estimation/objects.inv'),
        'legged_rl_controllers': ('http://docs.ros.org/en/latest/p/legged_rl_controllers/', '/home/runner/work/legged_control2_doc/legged_control2_doc/build/html/doc/rosdoc2/cross_reference/legged_rl_controllers/objects.inv')
    })
