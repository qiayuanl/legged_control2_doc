...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['controller_manager', 'ros2controlcli', 'robot_state_publisher', 'joint_state_broadcaster', 'joy_linux', 'joy_teleop', 'legged_estimation', 'controller_interface', 'realtime_tools', 'geometry_msgs', 'tf2_msgs', 'nav_msgs', 'visualization_msgs']:
        try:
